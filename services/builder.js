  ...
  static genMessageResponseSequence(sequence, msgParam){
    ...
    switch (sequence['message_type']) {
      case "SIMPLE_TEXT":
        ...
        return this.genTextWithPersona(message, 576039974115490);
      ...
      case "GENERIC":
        ...
        return this.genGenericTemplateWithPersona(elementGenericTemplateResponse, 576039974115490);
      ...
      case "QUICK_REPLIES":
        ...
        return this.genQuickReplyWithPersona(message, repliesElementList, 576039974115490);
